  ...
  return (
    <div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="grid grid-cols-3 gap-4">
                {[{ icon: Armchair, label: "Wheelchairs" }, { icon: PersonStanding, label: "Prosthetics" }, { icon: Eye, label: "Canes" }].map((item, i) => (
                  <motion.div 
                    key={i}
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        {/* Animated Background */}
        <motion.div 
          className="absolute top-10 right-0 w-72 h-72 bg-gradient-to-br from-teal-100/50 to-blue-100/50 rounded-full blur-3xl"
            ...
            >
              ...
              <div className="space-y-3">
                {benefits.map((benefit, index) => (
                  ...
                  >
                    <motion.div 
                      className="w-7 h-7 bg-teal-100 rounded-full flex items-center justify-center flex-shrink-0"
      ...
      <section className="py-20 bg-slate-50 relative overflow-hidden">
        {/* Floating Elements */}
        <motion.div 
          className="absolute bottom-20 right-10 w-24 h-24 border-2 border-blue-200 rounded-full opacity-50"
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {wheelchairTypes.map((type, index) => (
                <motion.div 
                  key={index} 
                  className="bg-white rounded-2xl p-6 shadow-md border border-slate-100 hover:shadow-xl hover:border-blue-200 transition-all duration-300 group"
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        {/* Animated Background */}
        <motion.div 
          className="absolute top-20 left-0 w-80 h-80 bg-gradient-to-br from-purple-100/50 to-pink-100/50 rounded-full blur-3xl"
          animate={{ scale: [1, 1.2, 1], x: [0, 40, 0] }}
          transition={{ duration: 15, repeat: Infinity }}
        />
        <motion.div 
          className="absolute bottom-20 right-0 w-72 h-72 bg-gradient-to-br from-green-100/40 to-teal-100/40 rounded-full blur-3xl"
        ...
        <div className="container mx-auto px-6 lg:px-12 relative">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <motion.div 
                className="bg-green-50 rounded-2xl p-6 border border-green-100 hover:shadow-xl hover:border-green-200 transition-all duration-300 group relative overflow-hidden"
                whileHover={{ y: -5, scale: 1.02 }}
              >
                {/* Shimmer Effect */}
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 overflow-hidden">
                ...
                <div className="space-y-3 relative z-10">
                  {prostheticBenefits.map((benefit, index) => (
                    ...
                    >
                      <motion.div 
                        className="w-7 h-7 bg-green-200 rounded-full flex items-center justify-center flex-shrink-0"
                        whileHover={{ scale: 1.2, rotate: 360 }}
                        transition={{ duration: 0.3 }}
                      >
            ...
            <motion.p 
              className="text-slate-500 text-sm italic mt-6 text-center"
              initial={{ opacity: 0 }}
      ...
      <section className="py-20 bg-slate-50 relative overflow-hidden">
        {/* Floating Elements */}
        <motion.div 
          className="absolute top-10 right-10 w-20 h-20 border-2 border-amber-200 rounded-full"
          animate={{ scale: [1, 1.2, 1], rotate: [0, 180, 360] }}
          transition={{ duration: 15, repeat: Infinity }}
        />
        <motion.div 
          className="absolute bottom-20 left-10 w-16 h-16 bg-amber-100 rounded-2xl opacity-50"
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              {caneTypes.map((type, index) => (
                <motion.div 
                  key={index} 
                  className="bg-white rounded-2xl p-6 shadow-md border border-slate-100 hover:shadow-xl hover:border-amber-200 transition-all duration-300 group cursor-pointer relative overflow-hidden"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                  transition={{ delay: index * 0.1 }}
                ...
                >
                  ...
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 overflow-hidden">
                    <motion.div 
                      className="absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-amber-100/50 to-transparent"
                      animate={{ x: ["-100%", "200%"] }}
                      transition={{ duration: 1.5, repeat: Infinity, repeatDelay: 2 }}
                    />
                  </div>
                  <motion.div 
                    className="w-10 h-10 bg-amber-100 rounded-full flex items-center justify-center mb-3 group-hover:bg-amber-500 transition-colors"
                    whileHover={{ scale: 1.1, rotate: 360 }}
                    transition={{ duration: 0.5 }}
                  >
                    <span className="text-amber-600 font-bold group-hover:text-white transition-colors">{index + 1}</span>
                  </motion.div>
                  <h4 className="font-semibold text-slate-900 mb-2 relative z-10">{type.title}</h4>
                  <p className="text-slate-600 text-sm relative z-10">{type.description}</p>
                </motion.div>
              ))}
            </div>

            <motion.div 
              className="bg-amber-50 rounded-2xl p-6 border border-amber-100 hover:shadow-lg transition-all duration-300"
              whileHover={{ y: -3 }}
            >
              ...
              <div className="flex flex-wrap gap-4">
                {caneBenefits.map((benefit, index) => (
                  ...
                  >
                    <motion.div 
                      className="w-6 h-6 bg-amber-200 rounded-full flex items-center justify-center flex-shrink-0"
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        {/* Animated Background */}
        <motion.div 
          className="absolute top-20 right-0 w-80 h-80 bg-gradient-to-br from-teal-100/40 to-blue-100/40 rounded-full blur-3xl"
          animate={{ scale: [1, 1.2, 1], x: [0, -30, 0] }}
          transition={{ duration: 12, repeat: Infinity }}
        />
        ...
        <div className="container mx-auto px-6 lg:px-12 relative">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <motion.div 
                className="bg-teal-50 rounded-2xl p-6 border border-teal-100 hover:shadow-xl hover:border-teal-200 transition-all duration-300 group relative overflow-hidden"
                whileHover={{ y: -5 }}
              >
                {/* Shimmer Effect */}
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 overflow-hidden">
              ...
              <motion.div 
                className="bg-blue-50 rounded-2xl p-6 border border-blue-100 hover:shadow-xl hover:border-blue-200 transition-all duration-300 group relative overflow-hidden"
                whileHover={{ y: -5 }}
              >
                {/* Shimmer Effect */}
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 overflow-hidden">
                ...
                <div className="space-y-3 relative z-10">
                  {braceUses.map((use, index) => (
                    ...
                    >
                      <motion.div 
                        className="w-7 h-7 bg-blue-200 rounded-full flex items-center justify-center flex-shrink-0"
                        whileHover={{ scale: 1.2, rotate: 360 }}
                        transition={{ duration: 0.3 }}
                      >
      ...
      <section className="py-20 bg-slate-50 relative overflow-hidden">
        {/* Floating Elements */}
        <motion.div 
          className="absolute top-10 left-10 w-24 h-24 border-2 border-pink-200 rounded-2xl"
          animate={{ rotate: [0, 45, 0], scale: [1, 1.1, 1] }}
          transition={{ duration: 10, repeat: Infinity }}
        />
        <motion.div 
          className="absolute bottom-20 right-10 w-16 h-16 bg-pink-100 rounded-full opacity-50"
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {walkersInfo.map((item, index) => (
                <motion.div 
                  key={index} 
                  className="bg-white rounded-2xl p-6 shadow-md border border-slate-100 hover:shadow-2xl hover:border-pink-200 transition-all duration-300 group cursor-pointer relative overflow-hidden"
                  initial={{ opacity: 0, y: 30 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                ...
                >
                  ...
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 overflow-hidden">
                    <motion.div 
                      className="absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-pink-100/50 to-transparent"
                      animate={{ x: ["-100%", "200%"] }}
                      transition={{ duration: 1.5, repeat: Infinity, repeatDelay: 2 }}
                    />
                  </div>
                  <motion.div 
                    className="w-12 h-12 bg-pink-100 rounded-full flex items-center justify-center mb-4 group-hover:bg-pink-500 transition-colors"
                    whileHover={{ scale: 1.2, rotate: 360 }}
                    transition={{ duration: 0.5 }}
                  >
                    <span className="text-pink-600 font-bold text-lg group-hover:text-white transition-colors">{index + 1}</span>
                  </motion.div>
                  <h4 className="font-semibold text-slate-900 mb-3 text-lg relative z-10">{item.title}</h4>
            ...
            >
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 relative z-10">
                {dailyLivingTools.map((tool, index) => (
                  <motion.div 
                    key={index} 
                    className="flex items-center gap-3 bg-white p-3 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 cursor-pointer group/item"
                  ...
                  >
                    <motion.div 
                      className="w-7 h-7 bg-green-200 rounded-full flex items-center justify-center flex-shrink-0 group-hover/item:bg-green-500 transition-colors"
                      whileHover={{ rotate: 360 }}
                      transition={{ duration: 0.5 }}
                    >
      ...
      <section className="py-20 bg-slate-50 relative overflow-hidden">
        {/* Floating Elements */}
        <motion.div 
          className="absolute top-10 right-10 w-20 h-20 border-2 border-indigo-200 rounded-full"
          animate={{ scale: [1, 1.2, 1], rotate: [0, 180, 360] }}
          transition={{ duration: 15, repeat: Infinity }}
        />
        <motion.div 
          className="absolute bottom-20 left-20 w-16 h-16 bg-indigo-100 rounded-2xl opacity-50"
        ...
        <div className="container mx-auto px-6 lg:px-12 relative">
          ...
          >
            <div className="flex items-center gap-4 mb-6">
              <motion.div 
                className="w-16 h-16 bg-indigo-100 rounded-2xl flex items-center justify-center shadow-lg"
                whileHover={{ rotate: [0, -10, 10, 0], scale: 1.1 }}
              >
            ...
            <motion.div 
              className="bg-white rounded-2xl p-8 shadow-md border border-slate-100 mb-6 hover:shadow-2xl transition-all duration-300 relative overflow-hidden group"
              whileHover={{ y: -5 }}
            >
              {/* Shimmer Effect */}
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 overflow-hidden">
                <motion.div 
                  className="absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-indigo-50/50 to-transparent"
                  animate={{ x: ["-100%", "200%"] }}
                  transition={{ duration: 2, repeat: Infinity, repeatDelay: 2 }}
                />
              </div>
              <div className="grid md:grid-cols-2 gap-4 relative z-10">
                {choosingFactors.map((factor, index) => (
                  <motion.div 
                    key={index} 
                    className="flex items-center gap-3 p-3 rounded-xl hover:bg-indigo-50 transition-colors cursor-pointer group/item"
                    initial={{ opacity: 0, x: -20 }}
                    whileInView={{ opacity: 1, x: 0 }}
                    viewport={{ once: true }}
                    transition={{ delay: index * 0.1 }}
                  ...
                  >
                    <motion.div 
                      className="w-10 h-10 bg-indigo-100 rounded-full flex items-center justify-center flex-shrink-0 group-hover/item:bg-indigo-500 transition-colors"
                      whileHover={{ scale: 1.2, rotate: 360 }}
                      transition={{ duration: 0.3 }}
                    >
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-10">
              {howWeHelp.map((item, index) => (
                <motion.div 
                  key={index} 
                  className="flex items-center gap-2 px-5 py-3 bg-pink-50 rounded-full shadow-sm hover:shadow-lg hover:bg-pink-100 transition-all duration-300 cursor-pointer group"
                  initial={{ opacity: 0, scale: 0.8 }}
                  whileInView={{ opacity: 1, scale: 1 }}
                  viewport={{ once: true }}
                  transition={{ delay: index * 0.1 }}
                ...
                >
                  <motion.div 
                    className="w-6 h-6 bg-pink-200 rounded-full flex items-center justify-center flex-shrink-0 group-hover:bg-pink-500 transition-colors"
                    whileHover={{ rotate: 360 }}
                    transition={{ duration: 0.5 }}
                  >
      ...
      <section className="py-20 bg-gradient-to-br from-red-700 to-orange-700 relative overflow-hidden">
        ...
        />
        <motion.div 
          className="absolute top-1/3 right-1/4 w-32 h-32 bg-purple-400/10 rounded-full blur-2xl"
